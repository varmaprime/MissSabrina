...
PM_START_TEXT = """
Hey there! My name is MissRosexXx - I'm here to help you manage your groups! Hit /help to find out more about how to use me to my full potential.

Want to add me to your chat? [Click here!](http://telegram.me/MissRose_xXx_Bot?startgroup=botstart) 
"""
...
Hey! My name is MissRosexXx . I am a group management bot, here to help you get around and keep the order in your groups!
...
If you have any bugs or questions on how to use me, here you can ask [My Creator](t.me/Unknown_Hacker_ZC) , or head to @MissRose_xXx_Bot_Support.
...
You can donate to [My Creator](t.me/Unknown_Hacker_ZC) , or if you want to help support me on a monthly basis, you can set up a recurring donation on [GitHub Sponsors](t.me/unknown_hacker_x) .
...
def send_start(bot, update):
    ...
    keyboard = [[
        InlineKeyboardButton(text=tld(chat.id, '🥳Add To Group'),
                             url="https://t.me/MissRose_xXx_Bot?startgroup=true"), InlineKeyboardButton(text="❓ Help", callback_data="help_back")
        ]]
    keyboard += [[
        InlineKeyboardButton(text=tld(chat.id, '👥 Support Group'), url="https://t.me/MissRose_xXx_Bot_Support")
    ]]
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 594813047 and DONATION_LINK:
            update.effective_message.reply_text("Yup! Really thank you for this!".format(DONATION_LINK),
                                                parse_mode=ParseMode.MARKDOWN)
